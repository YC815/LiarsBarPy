...
def record_round_info(game_count: int, round_count: int, players: list, rivew: dict, shooting_count: list, bullet_position: list, question: list, liar: list, target: str, p0_hand_card: list, p1_hand_card: list, p2_hand_card: list, p3_hand_card: list):
    """
    記錄回合資訊
